...
export const metadata: Metadata = {
  ...
  description:
    "Веб-студия Малина: разработка и создание веб-сайтов под ключ — корпоративные сайты с понятной админкой, лендинги и интернет-магазины. Технические задания на разработку, настройка SEO для продвижения в поисковых системах, документация и поддержка сайта.",
  keywords: [
