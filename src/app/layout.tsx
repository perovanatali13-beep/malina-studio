...
export const metadata: Metadata = {
  ...
  description:
    "Веб-студия Малина: разработка и создание веб-сайтов под ключ — корпоративные сайты с понятной админкой, лендинги и интернет-магазины. Лендинг от 3 000 ₽, сайт с админкой от 7 000 ₽, сайт под ключ с SEO от 15 000 ₽. Технические задания на разработку, настройка SEO для продвижения в поисковых системах, документация и поддержка сайта.",
  keywords: [
  ...
  "@graph": [
    {
      ...
      makesOffer: [
        ...
        },
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Сайт с админкой до 5 страниц и SEO-базой",
          },
          priceSpecification: {
            "@type": "PriceSpecification",
            price: "7000",
