...
export const metadata: Metadata = {
  ...
  description:
    "Веб-студия Малина: разработка и создание веб-сайтов под ключ — корпоративные сайты с понятной админкой, лендинги и интернет-магазины. Лендинг от 3 000 ₽, многостраничный сайт с админкой от 7 000 ₽, сайт под ключ с SEO от 10 000 ₽. Технические задания на разработку, настройка SEO для продвижения в поисковых системах, документация и поддержка сайта.",
  keywords: [
    ...
    "разработка сайта от 2000 рублей",
    "лендинг от 2000 рублей",
    "многостраничный сайт от 7000 рублей",
    "сайт под ключ от 10000 рублей",
  ...
  openGraph: {
    title: "Студия Малина — разработка и создание сайтов под ключ",
    description:
      "Веб-студия Малина: разработка и создание веб-сайтов под ключ — сайты с понятной админкой, лендинги, интернет-магазины. Настройка SEO, документация и поддержка.",
    url: "https://malina-studio.online",
    siteName: "Студия Малина",
    type: "website",
    locale: "ru_RU",
  },
  verification: {
  ...
  "@graph": [
    {
      ...
      makesOffer: [
        ...
        },
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Многостраничный сайт до 3 страниц с админкой и SEO-базой",
          },
          priceSpecification: {
            "@type": "PriceSpecification",
            price: "7000",
